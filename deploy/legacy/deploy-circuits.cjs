 ...
 *
 * Usage:
 *   npx hardhat run deploy/legacy/deploy-circuits.cjs --network theta-testnet
 *   npx hardhat run deploy/legacy/deploy-circuits.cjs --network theta-mainnet
 *   npx hardhat run deploy/legacy/deploy-circuits.cjs --network hardhat
 *

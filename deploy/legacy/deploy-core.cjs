 ...
 *
 * Usage:
 *   npx hardhat run deploy/legacy/deploy-core.cjs --network theta-testnet
 *   npx hardhat run deploy/legacy/deploy-core.cjs --network theta-mainnet
 *   npx hardhat run deploy/legacy/deploy-core.cjs --network hardhat       # local test
 *

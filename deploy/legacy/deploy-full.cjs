 ...
 *
 * Usage:
 *   npx hardhat run deploy/legacy/deploy-full.cjs --network theta-testnet
 *   npx hardhat run deploy/legacy/deploy-full.cjs --network theta-mainnet
 *   npx hardhat run deploy/legacy/deploy-full.cjs --network hardhat
 *

...
const TOOLS: Array<{ name: string; description: string }> = [
  ...
  { name: 'get_proof', description: 'Optional Tier-2: fetch SP1 settlement proof for a settled task.' },
  { name: 'verify_proof', description: 'Optional Tier-2: verify SP1 proof + payment binding; optional nullifier read.' },

...
Last updated: 2026-08-16 · Public Base mainnet x402 live · **Repo `main` @ `6173086`** · SDK `0.5.3` (receipt payload v3) · SP1 prover running · **Cost-plus is live ([ADR 0009](./adr/0009-cost-plus-pricing.md))** · **Rolling settlement accepted and on ([ADR 0008](./adr/0008-rolling-settlement.md)) — you pay for the last call; `/task-quote` is a forecast** · Next: outreach (4) — traffic is 0 tasks/24h, which is the real constraint
